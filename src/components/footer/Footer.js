      ...
      <div className="w-full px-4 mx-auto text-white max-w-7xl">
        <div className="flex flex-col md:flex-row justify-between items-center py-8">
          <div className="flex items-center gap-2 mb-4 md:mb-0">
            <img className="h-7 w-7" src="/footer-logo.png" alt="Play Casino Logo" />
            <span className="self-center text-2xl font-semibold whitespace-nowrap">RoyalBets</span>
          </div>
          <div className="flex space-x-5 mt-4 md:mt-0">
            {footerSocials.map((social) => (
              <a key={social.name} href={social.href} className="text-white hover:text-gray-300">
                {social.icon}
        ...
        <div className="border-t border-gray-700 py-4">
          <span className="block text-sm text-center tracking-tight">
